...
export default function AddCashScreen(props: ScreenProp) {
  ...
  const Tribeid = props?.route?.params?.id;
 
  const [SendMoneyByWallet, { data: response , loading}] = useMutation(DONATE_BY_WALLET);
            ...
            variables: { 
                payload:  {
                  ...
                  fiat: { 
                    ...
                    description: "", 
                    keyId,
                    source: {  id:fundingSource?.id, asset: 'USD', category: 'CARD' }
                },
                type: 'TRIBE_DONATE',
                origin: 'TRIBE' 
              }
            ...
            variables: { 
                payload:  {
                  ...
                  fiat: { 
                    ...
                    description: "", 
                    source: { id:fundingSource?.id, asset: 'USD', category: 'BANK_TRANSFER' }
                },
                type: 'TRIBE_DONATE',
                origin: 'TRIBE' 
              }
      ...
      await SendMoneyByWallet({
        variables: { 
            payload:  {
              amount: String(number), 
              walletId: Tribeid, 
              fiat: { verification:'none', description: "", source: {  asset: 'USD', category: 'WALLET' }
            },
            type: 'TRIBE_DONATE',
            origin: 'TRIBE' 
          }
